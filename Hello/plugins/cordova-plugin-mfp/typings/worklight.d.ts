...
declare module WL.Client {
    ...
    function init(initOptions?: Object): void;
        ...
        *		Note: This option is applicable for Android, iOS, Windows Phone Silverlight 8 and Windows 8 universal.
    ...
    function getLanguage(): string;
		...
		/**
        * Creates a challenge handler object. A security check name must be supplied as a parameter.
        * @param securityCheckName The security check name representing the challenge.
        * @methodOf WL.Client#
        */
    function createChallengeHandler(securityCheckName: string): WL.Client.ChallengeHandler;

		/**
       * Creates a challenge handler object to handle challenges that are sent by the MobileFirst Server.
       *  
       * A WLChallengeHandler works only with a security check that is based on the MobileFirst authentication protocol, 
       ...
       *  
       * handleChallenge() - This method is called when the MobileFirst Server returns a challenge for the security check.
       ...
       * 
       */
    function createWLChallengeHandler(securityCheckName: string): WL.Client.WLChallengeHandler;
...
class WLChallengeHandler extends AbstractChallengeHandler{
    MAX_NUMBER_OF_FAILURES: number;
	numOfFailures: number;
    submitChallengeAnswer(answer?: any): void;
    processSuccess(identity?: any): void;
    handleFailure(err?: any): void;
   
}

class ChallengeHandler extends AbstractChallengeHandler{
